...
{               ?>  
    ...
    <div class="menu">
        <ul id="menu" >
            ...
            <li><a href="manage-appoiment.php"><i class="fa fa-table"></i> <span>Appoiment List</span></a></li>


           
            <li><a href="search-invoices.php"><i class="fa fa-search"></i> <span>Search Appoiment</span></a></li>
