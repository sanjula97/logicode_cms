...
$sql="delete tblclient set AccountType=:accttype,ContactName=:cname,CompanyName=:comname,Address=:address,City=:city,State=:state,ZipCode=:zcode,Workphnumber=:wphnumber,Cellphnumber=:cellphnumber,Otherphnumber=:ophnumber,Email=:email,WebsiteAddress=:websiteadd,Notes=:notes where ID=:eid";
...
{               ?>								
	...
	<?php $cnt=$cnt+1;}} ?>
	 ...
	 <button type="submit" class="btn btn-default" name="delete" id="submit">Delete</button>
